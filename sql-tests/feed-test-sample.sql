-- create the view of reviews for user 87
CREATE OR REPLACE VIEW "reviewsAndLikesForUser87" AS
...
FROM "reviewsAndLikesForUser87", "User", "Cafe"
WHERE "reviewsAndLikesForUser87"."author" = "User"."id" AND
    "reviewsAndLikesForUser87"."cid" = "Cafe"."id"
